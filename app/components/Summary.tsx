...
const Summary = ({ feedback }: { feedback: Feedback }) => {
    ...
    // Check if all scores are 0 (likely parsing error)
    if (overallScore === 0 && !feedback?.overallScore) {
        return (
            <div className="bg-white rounded-2xl shadow-md w-full p-6">
                <p className="text-red-600">Error: Unable to load feedback data. Please try uploading your resume again.</p>
            </div>
        );
    }
