...
**[Visit RESUMIND](https://resumind-theta-five.vercel.app/)**
...
1. **Login** — Authenticate securely using your Puter.js account
2. **Enter Job Details** — Input the company name, target role and full job description
3. **Upload Resume** — Upload your resume in PDF format
4. **AI Analysis** — RESUMIND internally converts your PDF to an image and runs AI-powered keyword analysis against the job description
5. **Get Results** — Receive your ATS compatibility score, highlighted concern points, and a detailed list of issues to fix
...
Feel free to check the [issues page](https://github.com/chartak26/RESUMIND/issues) or submit a pull request.
